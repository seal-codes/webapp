- If you need to understand what this project is about, check the README.md (for functional scope and ideas) and the ARCHITECTURE.md for technical design and implementation ideas.
