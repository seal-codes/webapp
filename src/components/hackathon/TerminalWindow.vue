<template>
  <div class="terminal-container">
    <div class="terminal-window">
      ...
      <div
        ref="terminalContent"
        class="terminal-content shadow-white-900/50"
          ...
          >
            ...
            >
              <div class="summary-line bolt">
                [BOLT.NEW] Core Systems:
                {{ dnaData.totals.bolt_lines.toLocaleString() }} LOC
              </div>
              <div class="summary-line manual">
                [MANUAL] Enhancements:
                {{ dnaData.totals.manual_lines.toLocaleString() }} LOC
              </div>
              <div class="summary-line total">
                Total Analyzed:
                {{ dnaData.totals.analyzed_lines.toLocaleString() }} LOC
              </div>
              <div class="impact-line">
                Impact: {{ dnaData.impact.bolt_percentage }}% bolt.new
                foundation, {{ dnaData.impact.manual_percentage }}% manual
                polish
              </div>
            </div>
          </div>
