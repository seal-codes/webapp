      ...
      <div class="chart-container">
        <div class="chart-header">
          <div class="chart-title">
            Development Activity by Session
          </div>
          ...
          >
            ...
            >
              ...
              <div class="tooltip-subtitle">
                Ongoing refinements and tweaks
              </div>
            </div>
            <div
              v-else-if="hoveredSession"
              class="tooltip-header"
            >
              <div class="tooltip-title">
                {{ getSessionTitle(hoveredSession) }}
              </div>
              <div class="tooltip-date">
                {{ formatDate(getSessionData(hoveredSession)?.date || '') }}
              </div>
            </div>
            
            <div
              v-if="!tooltipData.isNoise && hoveredSession"
              class="tooltip-stats"
            >
...
const handleMouseMove = (event: MouseEvent) => {
  if (!chartSvg.value || !timelineData.value) {
    return
  }
