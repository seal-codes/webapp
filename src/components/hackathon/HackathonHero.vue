  ...
  <section class="hackathon-hero">
    <div class="hero-content">
      ...
      >
        ...
        <div
          class="metric-card primary large"
          :title="`Based on ${dnaData.coverage.line_coverage_percent}% codebase coverage analysis`"
        >
          <div class="metric-value">
            <AnimatedCounter
              :target="dnaData.impact.bolt_percentage"
              suffix="%"
            />
          </div>
          <div class="metric-label">
        ...
        <div
          class="metric-card secondary"
          :title="`Based on ${dnaData.coverage.line_coverage_percent}% codebase coverage analysis`"
        >
          <div class="metric-value">
            <AnimatedCounter
              :target="dnaData.impact.manual_percentage"
              suffix="%"
            />
          </div>
          <div class="metric-label">
      ...
      <div class="insights-section">
        ...
        <div class="insights-grid">
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 1"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 1 }"
            >
              <Zap
                class="insight-icon"
                :class="{ faded: hoveredInsight === 1 }"
              />
            ...
            <div
              class="insight-back"
              :class="{ visible: hoveredInsight === 1 }"
            >
              <div class="insight-text">
                Enhance prompt, scaffold immediately, iterate on abstract concepts in real-time
              </div>
            </div>
          </div>
          ...
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 2"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 2 }"
            >
              <Brain
                class="insight-icon"
                :class="{ faded: hoveredInsight === 2 }"
              />
              <div class="insight-title">
          ...
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 3"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 3 }"
            >
              <RotateCcw
                class="insight-icon"
                :class="{ faded: hoveredInsight === 3 }"
              />
              <div class="insight-title">
                Itereate – also outside of bolt.new
              </div>
            </div>
            <div
              class="insight-back"
              :class="{ visible: hoveredInsight === 3 }"
            >
              <div class="insight-text">
                Deliberate refactoring breaks (using my IDE or AI peer reviewers) prevent technical debt and maintain architectural clarity
              </div>
            </div>
          </div>
          ...
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 4"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 4 }"
            >
              <Sparkles
                class="insight-icon"
                :class="{ faded: hoveredInsight === 4 }"
              />
              <div class="insight-title">
          ...
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 5"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 5 }"
            >
              <Globe
                class="insight-icon"
                :class="{ faded: hoveredInsight === 5 }"
              />
              <div class="insight-title">
          ...
          <div
            class="insight-card"
            @mouseenter="hoveredInsight = 6"
            @mouseleave="hoveredInsight = null"
          >
            <div
              class="insight-front"
              :class="{ blurred: hoveredInsight === 6 }"
            >
              <TrendingUp
                class="insight-icon"
                :class="{ faded: hoveredInsight === 6 }"
              />
              <div class="insight-title">
