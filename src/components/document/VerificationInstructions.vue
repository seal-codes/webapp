  ...
  <div>
    ...
    <div class="bg-gray-50 p-4 rounded-lg">
      <ol class="space-y-4">
        <li class="flex items-start">
          <div class="bg-primary-500 text-white rounded-full w-6 h-6 flex items-center justify-center mr-3 flex-shrink-0 mt-1">
            1
          </div>
          <div>
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mt-6">
      <p class="text-sm text-blue-700">
        <strong>Note:</strong> The seal verification process confirms that the document has not been altered since it was sealed.
      </p>
    </div>
  </div>
</template>