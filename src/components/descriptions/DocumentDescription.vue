  ...
  <div>
    ...
    <div class="bg-blue-50 border-l-4 border-blue-500 p-4 mt-6">
      <p class="text-sm text-blue-700">
        <strong>Privacy Note:</strong> Authentication is only used to create a unique identifier for your seal. We don't store your documents or personal information.
      </p>
    </div>
  </div>
</template>